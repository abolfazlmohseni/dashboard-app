const MiniCard = () => {
  return (
    <>
      <div className="bg-white rounded-xl flex flex-col justify-center items-start w-[33%] px-5 py-8">
        <div className="w-12 h-12 bg-success-80/20 flex items-center justify-center rounded-xl ">
          <svg
            width="18"
            height="18"
            viewBox="0 0 18 18"
        ...
        <p className="text-3xl font-bold text-dark-100 mt-3.5">36.1K</p>
        <p className="text-sm text-gray-100 mt-2.5">Total Sessions</p>
      </div>
      <div className="bg-white rounded-xl flex flex-col justify-center items-start w-[33%] px-5 py-8 mx-[30px]">
        <div className="w-12 h-12 bg-primary-80/20 flex items-center justify-center rounded-xl ">
          <svg
            width="18"
            height="18"
            viewBox="0 0 18 18"
        ...
        <p className="text-3xl font-bold text-dark-100 mt-3.5">2,642</p>
        <p className="text-sm text-gray-100 mt-2.5">Total Visitors</p>
      </div>
      <div className="bg-white rounded-xl flex flex-col justify-center items-start w-[33%] px-5 py-8">
        <div className="w-12 h-12 bg-error-80/20 flex items-center justify-center rounded-xl ">
          <svg
            width="18"
            height="18"
            viewBox="0 0 18 18"
        ...
        <p className="text-3xl font-bold text-dark-100 mt-3.5">3.21</p>
        <p className="text-sm text-gray-100 mt-2.5">Avg Time Spend</p>
      </div>
    </>
  );
};
