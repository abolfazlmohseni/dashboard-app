...
const Login = () => {
  ...
  return (
    <LoginBase>
      ...
      <button className="flex items-center justify-center my-4 sm:my-5 bg-primary-100 text-white font-bold w-full h-14 rounded-xl">
        Login
      </button>
      <button className="flex items-center justify-center text-dark-100 dark:text-white font-bold border-2 border-gray-80/20 rounded-xl w-full h-14">
        Create an account
      </button>
    </LoginBase>
  );
